...
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cpu/data_hazard_stall
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cpu/control_hazard_stall
...
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cpu/ir_out_EX
...
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cache/icache_core/equals
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cache/icache_core/hits
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cache/icache_core/valids
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cache/icache_core/load_cache
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cache/icache_core/way
...
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cache/icache_core/index_ACT
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cache/icache_core/tag_ACT
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cache/icache_core/way
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cache/icache_core/downstream_read
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cache/icache_core/downstream_resp
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cache/icache_core/downstream_rdata_ACT
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cache/icache_core/downstream_rdata_IDX
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cache/icache_core/downstream_rdata_IDX_selected
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cache/icache_core/downstream_ready_ACT
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cache/icache_core/downstream_ready_IDX
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cache/icache_core/downstream_ready_IDX_selected
add wave -noupdate /urchin_tb/dut/cache/icache_core/read_ACT
add wave -noupdate /urchin_tb/dut/cache/icache_core/write_ACT
add wave -noupdate /urchin_tb/dut/cache/icache_core/downstream_resp_IDX
add wave -noupdate /urchin_tb/dut/cache/icache_core/request_ongoing
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cpu/br_en
...
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cache/dcache_core/address_ACT
...
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cache/dcache_core/downstream_resp
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cache/dcache_core/hit
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cache/dcache_core/pipe
...
add wave -noupdate /urchin_tb/dut/cache/l2_cache_core/request_ongoing
add wave -noupdate /urchin_tb/dut/cache/l2_cache_core/pipe
add wave -noupdate /urchin_tb/dut/cache/l2_cache_core/do_wb
add wave -noupdate /urchin_tb/dut/cache/l2_cache_core/read_ACT
add wave -noupdate /urchin_tb/dut/cache/l2_cache_core/write_ACT
add wave -noupdate /urchin_tb/dut/cache/l2_cache_core/request_ACT
...
add wave -noupdate /urchin_tb/dut/cache/l2_cache_core/upstream_ready
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cache/l2_cache_core/upstream_address
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cache/l2_cache_core/lru
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cache/l2_cache_core/new_lru
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cache/l2_cache_core/hit
add wave -noupdate -radix binary /urchin_tb/dut/cache/l2_cache_core/hits
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cache/l2_cache_core/way
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cache/l2_cache_core/downstream_rdata_ACT
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cache/l2_cache_core/downstream_rdata_IDX
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cache/l2_cache_core/downstream_rdata_IDX_selected
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cache/l2_cache_core/downstream_ready_ACT
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cache/l2_cache_core/downstream_ready_IDX
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cache/l2_cache_core/downstream_ready_IDX_selected
add wave -noupdate /urchin_tb/dut/cache/l2_cache_core/downstream_resp_IDX
...
add wave -noupdate -radix hexadecimal /urchin_tb/pmem_address
add wave -noupdate /urchin_tb/pmem_write
add wave -noupdate -radix hexadecimal /urchin_tb/pmem_rdata
add wave -noupdate /urchin_tb/dut/cache/arbiter/downward_state
add wave -noupdate /urchin_tb/dut/cache/arbiter/upward_state
add wave -noupdate /urchin_tb/memory/resp
add wave -noupdate /urchin_tb/memory/error
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cache/l2_pmem_request_reg/out
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cache/l2_pmem_request_reg/load
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cache/l2_pmem_request_reg/in
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cache/l2_pmem_request_reg/data
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {205453 ps} 0}
