...
add wave -noupdate /urchin_tb/dut/cache/icache_core/hit
add wave -noupdate /urchin_tb/dut/cache/icache_core/equals
add wave -noupdate /urchin_tb/dut/cache/icache_core/hits
add wave -noupdate /urchin_tb/dut/cache/icache_core/valids
add wave -noupdate /urchin_tb/dut/cache/icache_core/load_cache
add wave -noupdate /urchin_tb/dut/cache/icache_core/way
...
WaveRestoreCursors {{Cursor 1} {314747 ps} 0}
...
update
WaveRestoreZoom {0 ps} {444848 ps}
