...
add wave -noupdate /urchin_tb/dut/cpu/irm/with_low_full
add wave -noupdate /urchin_tb/dut/cpu/irm/with_half
add wave -noupdate /urchin_tb/dut/cpu/irm/_with_low_full
add wave -noupdate /urchin_tb/dut/cpu/irm/_with_half
add wave -noupdate /urchin_tb/dut/cpu/irm/irh_sel
add wave -noupdate /urchin_tb/dut/cpu/irm/irl_sel
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cpu/irm/pc
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cpu/irm/pc_
add wave -noupdate /urchin_tb/dut/cpu/irm/j
add wave -noupdate /urchin_tb/dut/cpu/irm/stall
add wave -noupdate /urchin_tb/dut/cpu/ir_stall
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cpu/force_nop
add wave -noupdate /urchin_tb/dut/cpu/control_hazard_stall
add wave -noupdate /urchin_tb/dut/cpu/control_hazard_1_bit
add wave -noupdate /urchin_tb/dut/cpu/control_hazard_2_bit
...
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cpu/ir
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cpu/irm/_half_instr
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cpu/irm/_low_full_instr
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cpu/irm/half_instr
add wave -noupdate -radix hexadecimal /urchin_tb/dut/cpu/irm/low_full_instr
...
add wave -noupdate /urchin_tb/dut/cpu/jump
...
WaveRestoreCursors {{Cursor 1} {53975000 ps} 0}
...
update
WaveRestoreZoom {53822961 ps} {54397181 ps}
