...
add wave -noupdate -radix hexadecimal /urchin_tb/cpu/fwu/rs1_out_sel
add wave -noupdate -radix hexadecimal /urchin_tb/cpu/fwu/rs2_out_sel
add wave -noupdate -radix hexadecimal /urchin_tb/cpu/alu_out
add wave -noupdate -radix hexadecimal /urchin_tb/cpu/alumux1_out
add wave -noupdate -radix hexadecimal /urchin_tb/cpu/alumux2_out
add wave -noupdate -radix hexadecimal /urchin_tb/cpu/rs1
add wave -noupdate -radix hexadecimal /urchin_tb/cpu/rs1_EX
add wave -noupdate -radix hexadecimal /urchin_tb/cpu/rs1_out_EX
add wave -noupdate -radix hexadecimal /urchin_tb/cpu/rs2
add wave -noupdate -radix hexadecimal /urchin_tb/cpu/rs2_EX
add wave -noupdate -radix hexadecimal /urchin_tb/cpu/rs2_out_EX
add wave -noupdate -radix hexadecimal /urchin_tb/cpu/rs2_out_MEM
add wave -noupdate -radix hexadecimal /urchin_tb/cpu/regfile_in_MEM
add wave -noupdate -radix hexadecimal /urchin_tb/cpu/regfile_in_WB
add wave -noupdate -radix hexadecimal /urchin_tb/cpu/rd
add wave -noupdate -radix hexadecimal /urchin_tb/cpu/rd_EX
add wave -noupdate -radix hexadecimal /urchin_tb/cpu/rd_MEM
add wave -noupdate -radix hexadecimal /urchin_tb/cpu/rd_WB
add wave -noupdate -radix hexadecimal /urchin_tb/cpu/cmp/cmpop
add wave -noupdate -radix hexadecimal /urchin_tb/cpu/cmp/arg1
add wave -noupdate -radix hexadecimal /urchin_tb/cpu/cmp/arg2
add wave -noupdate -radix hexadecimal /urchin_tb/cpu/cmp/br_en
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {80143 ps} 0}
